...
def agent_card(cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "skills": [
            ...
            {"id": "fetch_handshake_files", "name": "Fetch handshake files",
             "description": "Returns captured handshake files with path, filename, size, age.",
             "tags": ["handshakes"],
             "examples": ["{\"action\":\"fetch_handshake_files\",\"args\":{\"limit\":20}}"]},
